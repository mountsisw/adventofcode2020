...
class PuzzleSolution extends PuzzlePart
{
    ...
    private ingredientsWithAllergins: Map<string, string>;
    private allerginsDetermined: Array<string>;
    ...
    public init(inputElement: HTMLDivElement, outputElement: HTMLDivElement, answerElement: HTMLDivElement)
    {
        ...
        this.ingredientsWithAllergins = new Map();
        this.allerginsDetermined = new Array();
    }
    ...
    public displayAnswer()
    {
        ...
        this.allerginsDetermined.forEach(value =>
            this.answerDisplay.innerHTML += this.ingredientsWithAllergins.get(value) + ",", this);
    ...
    private recordAllergin(ingredientName: string, allerginName: string)
    {
        ...
        this.ingredientsWithAllergins.set(allerginName, ingredientName);
        this.allerginsDetermined.push(allerginName);
    }
}