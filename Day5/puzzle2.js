...
function init()
{
    ...
    IDs.sort((a, b) => a - b);
    for (let loop3 = 1; loop3 < IDs.length; loop3++)
        if (IDs[loop3] == IDs[loop3 - 1] + 2)
        {
            document.getElementById("output").innerText = "Your seat ID is " + String(IDs[loop3] - 1);
            return;
        }
    document.getElementById("output").innerText = "Seat not found";
}
